!(function (y) {
  "function" == typeof define && define.amd ? define(y) : y();
})(function () {
  function y(h, b) {
      ...
      function (h) {
        for (var b = 1; b < arguments.length; b++) {
          var f = arguments[b],
            c;
          for (c in f)
            Object.prototype.hasOwnProperty.call(f, c) && (h[c] = f[c]);
        }
        return h;
  ...
  function G(h, b, f) {
    return (G = M()
      ...
      : function (c, g, a) {
          var d = [null];
          d.push.apply(d, g);
          c = new (Function.bind.apply(c, d))();
          return a && A(c, a.prototype), c;
  ...
  function H(h) {
    ...
    return (H = function (f) {
      function c() {
        return G(f, arguments, F(this).constructor);
      }
      if (
        null === f ||
        ((g = f), -1 === Function.toString.call(g).indexOf("[native code]"))
      )
        return f;
      var g;
  ...
  var x = {},
    L = function (h) {
      ...
      var g = b.labels,
        ...
        q = g ? 18 : 0;
      b = [];
      for (var t = 0; t < c; t += 1) b.push(t);
      var J = [];
      for (t = 0; 7 > t; t += 1) J.push(t);
      var z,
        w = (e - v - 4 * (c - 1)) / c;
      e += 5;
      t = q + 7 * w + 24 + 7;
      var B = ((z = 7 * c), (z -= 7 - new Date().getDay()));
      z = (function () {
        for (
          var m, n = [], r = new Date().getTime() - 864e5 * B, p = 0;
          p < c;
          p += 1
        ) {
          var u = new Date(r + 6048e5 * p).getMonth();
          m !== u && (n.push({ weekIndex: p, month: u }), (m = u));
        }
        return n;
      })();
      var K = function (m, n) {
          var r = B - (7 * m + n + 1);
          r = new Date(new Date().getTime() - 864e5 * r);
          var p = function (u) {
            return 10 > u ? "0" + u : u;
          };
          return (
            r.getFullYear() + "-" + p(r.getMonth() + 1) + "-" + p(r.getDate())
          );
        },
        O = function (m, n) {
          var r = ["codersrank-activity-day"],
            p = (function (u) {
              var C = 0;
              if (!f || !u) return C;
              var D = f[u];
          ...
          p = 0 < p ? Math.min(Math.floor(p / d), 3) + 1 : 0;
          return (
            p && r.push("codersrank-activity-day-" + p),
            7 * m + n + 1 > B && r.push("codersrank-activity-day-disabled"),
            r.join(" ")
          );
        };
      return (
    ...
    P = (function (h) {
      ...
      var f,
        ...
        g = b.prototype;
      return (
        (g.getTotalActivities = function (a) {
          void 0 === a && (a = {});
          var d = 0;
          return (
        ...
        (g.emitData = function (a) {
          void 0 === a && (a = {});
          a = new CustomEvent("data", {
            detail: { data: a, total: this.getTotalActivities(a) },
          });
          this.dispatchEvent(a);
        }),
        (g.emitError = function (a) {
          a = new CustomEvent("error", { detail: a });
          this.dispatchEvent(a);
        }),
        (g.render = function () {
          var a = this.id,
          ...
          (this.username || a) &&
            ...
            (3 === k
              ...
              ? (l.innerHTML = "")
              : (0 !== k && 1 !== k) ||
                (l.innerHTML = L(E({}, v, { preloader: !0, data: {} }))),
            (a = e.querySelector(".codersrank-activity")) &&
              a.parentNode.removeChild(a),
            (a = l.querySelector(".codersrank-activity")) &&
              ((this.widgetEl = a),
              this.detachEvents(),
              this.attachEvents(),
              e.appendChild(a)));
        }),
        (g.loadAndRender = function () {
          var a = this,
            d = this.username,
            k = this.id;
          this.state = 1;
          this.render();
          (function (e, l) {
            if (e && x[e]) return Promise.resolve(x[e]);
            if (l && x[l]) return Promise.resolve(x[l]);
            var v =
              "https://api.codersrank.io/v2/users/" + (e || l) + "/activities";
            return (
              l && (v += "?get_by=id"),
              fetch(v, {
                method: "GET",
        ...
        (g.activitiesInDay = function (a) {
          var d = 0;
          if (!this.data || !a) return d;
          var k = this.data[a];
          return (
            k &&
        ...
        (g.showTooltip = function (a) {
          if (this.data && a && this.tooltip && this.widgetEl && this.data[a]) {
            var d = this.shadowEl.querySelector('[data-date="' + a + '"]');
            if (d) {
              ...
              var k = this.tempDiv.querySelector(
                  ".codersrank-activity-tooltip"
                ),
                e = d.left - a.left,
                l = -5;
              110 > e && ((l = -5 - (110 - e)), (e = 110));
              e + 110 > a.width &&
                ((l = 105 - (a.width - e)), (e = a.width - 110));
              l = Math.max(Math.min(l, 105), -105);
              k.style.left = e + "px";
              k.style.top = d.top - a.top + "px";
              k.querySelector(
                ".codersrank-activity-tooltip-angle"
              ).style.marginLeft = l + "px";
              this.shadowEl.appendChild(k);
            }
          }
        }),
        (g.hideTooltip = function () {
          if (this.tooltip && this.widgetEl) {
            var a = this.shadowEl.querySelector(".codersrank-activity-tooltip");
            a && this.shadowEl.removeChild(a);
          }
        }),
        (g.onMouseEnter = function (a) {
          "rect" === a.target.tagName &&
            ((a = a.target.getAttribute("data-date")), this.showTooltip(a));
        }),
        ...
        (c = [
          {
            ...
            get: function () {
              return "username weeks svg-width legend labels id".split(" ");
            },
          },
        ]),
        (f = [
          ...
          },
          {
            ...
            get: function () {
              return Math.min(
                parseInt(this.getAttribute("weeks") || 52, 10),
                52
              );
            },
            set: function (a) {
              this.setAttribute("weeks", a);
            },
          },
          {
            key: "svgWidth",
            get: function () {
              var a = parseInt(this.getAttribute("svg-width") || 0, 10);
              return !a && 52 > this.weeks ? 800 / (52 / this.weeks) : a || 800;
            },
            set: function (a) {
              this.setAttribute("svg-width", a);
            },
          },
          {
            key: "svg-width",
          ...
          },
          {
            key: "legend",
            get: function () {
              var a = this.getAttribute("legend");
              return "" === a || "true" === a;
            },
            set: function (a) {
              this.setAttribute("legend", a);
            },
          },
          {
            key: "labels",
            get: function () {
              var a = this.getAttribute("labels");
              return "" === a || "true" === a;
            },
            set: function (a) {
              this.setAttribute("labels", a);
            },
          },
          {
            key: "step",
  ...
  window.customElements &&
    !window.customElements.get("codersrank-activity") &&
    window.customElements.define("codersrank-activity", P);
});
